...
import udemyLogo from "../img/udemy.png";
      ...
      <div id="estudios" className="contenedor-estudios">
        ...
        <div className="estudios d-flex align-items-center justify-content-center flex-column">
          <div className="estudio-card card-2">
            ...
            <p>2021-2022</p>
            <a href="https://www.freecodecamp.org/certification/Alberto-Puet/responsive-web-design" target='_blank'><GrCertificate className="certificado"/></a>
            </div>
          </div>
          <div className="estudio-card card-1">
            ...
            <div className="separacion">
            <p>2022</p>
            <a href="https://www.udemy.com/certificate/UC-6bdaf141-54d9-4ca4-89d7-83bf48b6f458/" target='_blank'><GrCertificate className="certificado"/></a>
            </div>
          </div>
          ...
          <div className="logo-3">
            ...
            <p>1er etapa #SeProgramar finalizada - Cursando 2da etapa #YoProgramo</p>
            <div className="separacion">
            <p>2022</p>
            <a href="https://seprogramar.inti.gob.ar/inti/certificates/verify/Zp7ugWH8quh4ooVK" target='_blank'><GrCertificate className="certificado"/></a>
            </div>
          </div>
